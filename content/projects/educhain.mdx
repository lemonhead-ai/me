---
title: "Educhain AI"
description: "EduChainAI is a next-generation data platform that combines AI and blockchain to digitize and secure ECDE school management.
Mobile & Web Apps: Headteachers report data via an offline-first mobile app, while county officers use a web dashboard for real-time visibility. 
Devs:Isaiah Makau ~ Backend, Bob Simba ~ Web Frontend, Martin Mwai ~ Mobile App"
date: "2025-10-29"
